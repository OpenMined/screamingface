# screamingface-engine protocol

The wire contract for screamingface-engine telemetry and control. It is deliberately built from **named,
...
| Attribute | Requirement | screamingface-engine usage |
|---|---|---|
