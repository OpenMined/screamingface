...
in-process URL4 run, and verifies its terminal result. It uses the deterministic
`/desktop-runtime-smoke` data route and does not call or charge a model provider. The smoke command
is development tooling, not a second shipped sidecar.
