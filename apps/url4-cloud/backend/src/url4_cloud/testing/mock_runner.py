"""A fixture-event generator for the url4-cloud wire protocol: builds a fixed, deterministic
sequence of protocol events (`build_run`) for one fake run — no url4 execution, no model calls.
