...
before the Job starts.
    ...
    uv run python -m url4_cloud.benchmarks.healthbench.prepare --out /opt/benchmarks/healthbench
...
from url4_cloud.benchmarks.healthbench.definition import DATASET, DATASET_REVISION
...
def load_rows() -> list[dict[str, Any]]:
    ...
    ``datasets`` is NOT a dependency of url4-cloud — this runs at image build time on a
