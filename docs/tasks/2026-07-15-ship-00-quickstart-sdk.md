...
removed from the Phase 1 SDK. The target SDK always calls the effective HTTP URL4 engine. The
engine implementation is now a separate ownership and deployment boundary; only that service
reaches AI Gateway.
