...
Over-permissiveness hardening. Python \w is Unicode-aware where ABNF means ASCII; annotation parsing validates structure but never charsets. No wrong behaviour today — the parser is a strict superset.
