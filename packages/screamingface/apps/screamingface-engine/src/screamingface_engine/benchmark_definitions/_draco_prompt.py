"""DRACO's byte-pinned official per-criterion judge system prompt."""

from __future__ import annotations

DRACO_JUDGE_PROMPT = """You are evaluating a response for a given query against a single \
criterion.
