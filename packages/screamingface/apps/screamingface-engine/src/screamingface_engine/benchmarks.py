...
def gpqa_cases() -> str:
    ...
    try:
        from screamingface_engine.benchmark_definitions.gpqa import gpqa_cases as load_gpqa_cases
...
def _draco_rows(*, preview: bool = False, lite: bool = False) -> str:
    ...
    try:
        if preview:
            from screamingface_engine.benchmark_definitions.draco_preview import (
                draco_preview_cases as load_cases,
            )
        elif lite:
            from screamingface_engine.benchmark_definitions.draco_lite import (
                draco_lite_cases as load_cases,
            )
        else:
            from screamingface_engine.benchmark_definitions.draco import draco_cases as load_cases
