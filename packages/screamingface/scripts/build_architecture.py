...
Have a compatible ScreamingFace engine available. The SDK package does not bundle or start one;
set `SCREAMINGFACE_ENGINE_URL` below when it is not running at the temporary localhost default.
