// SVG logo components for CollaboratorsGrid.
// All use currentColor — controlled by parent's text color class.
// Replace placeholder logos with actual partner SVGs as collaborations are confirmed.

type LogoProps = { className?: string };

// ── simple-icons paths (CC0) ──────────────────────────────────────────────────

export function LogoHuggingFace({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-label="Hugging Face">
...
export function LogoMozilla({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-label="Mozilla">
...
export function LogoArXiv({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-label="arXiv">
...
export function LogoMIT({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 58 30" className={className} fill="currentColor" aria-label="MIT">
      <text
        y="26"
...
export function LogoWired({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 104 26" className={className} fill="currentColor" aria-label="Wired">
      <text
        y="22"
        fontFamily="Rubik, system-ui, sans-serif"
        fontWeight="700"
...
export function LogoEleutherAI({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 108 24" className={className} fill="currentColor" aria-label="EleutherAI">
      <text
        y="19"
        fontFamily="Rubik, system-ui, sans-serif"
        fontWeight="500"
